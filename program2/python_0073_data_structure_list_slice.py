...
print(L[2:7]) # Please figure out output value here, run it, verify your answer.
# start: 2
# stop: 7
# step: 1
# L[2:7] doesn't have step, so Python assumes step equals to 1
# so L[2:7] equals to L[2:7:1]
print(L[2:7:1]) # Please figure out output value here, run it, verify your answer.


print("2) Slice with Negative Indices ------------------")
print(L[-7:-2]) # Please figure out output value here, run it, verify your answer.
# start: -7
# stop: -2
# step: 1
# L[-7:-2] doesn't have step, so Python assumes step equals to 1
# so L[-7:-2] equals to L[-7:-2：1]
print(L[-7:-2:1]) # Please figure out output value here, run it, verify your answer.


print("3) Slice with Positive & Negative Indices ------------------")
print(L[2:-5]) # Please figure out output value here, run it, verify your answer.

print("4) Specify Step of the Slicing ------------------------------")
print(L[2:7:2]) # Please figure out output value here, run it, verify your answer.

print("5) Negative Step Size ---------------------------------------")
print(L[6:1:-2]) # Please figure out output value here, run it, verify your answer.

print("6) Slice at Beginning & End ---------------------------------")
print(L[:3]) # Please figure out output value here, run it, verify your answer.
...
print(L[6:]) # Please figure out output value here, run it, verify your answer.
...
print(L[::-1]) # Please figure out output value here, run it, verify your answer.
...
L[1:4] = [1,2,3]
print(L) # Please figure out output value here, run it, verify your answer.
