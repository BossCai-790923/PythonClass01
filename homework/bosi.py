...
if st in green_line:
    print(st, 'is in green_line')
if st in green_sub_line:
    print(st, 'is in green_sub_line')
if st in red_line:
    print(st, 'is in red_line')
if st in yellow_line:
    print(st, 'is in yellow_line')
if st in yellow_sub_line:
    print(st, 'is in yellow_sub_line')
if st in purple_line:
    print(st, 'is in purple_line')
if st in brown_line:
    print(st, 'is in brown_line')

if end in green_line:
    print(end, 'is in green_line')
if end in green_sub_line:
    print(end, 'is in green_sub_line')
if end in red_line:
    print(end, 'is in red_line')
if end in yellow_line:
    print(end, 'is in yellow_line')
if end in yellow_sub_line:
    print(end, 'is in yellow_sub_line')
if end in purple_line:
    print(end, 'is in purple_line')
if end in brown_line:
    print(end, 'is in brown_line')
        ...
        for a in range(len(transit_station_lines_dict[st_line])):
            for b in range(len(transit_station_lines_dict[endline])):
                if tuple(transit_station_lines_dict[st_line])[a] == tuple(transit_station_lines_dict[endline])[b]:
                    ...
                    c = False
                if tuple(transit_station_lines_dict[st_line])[a] == tuple(transit_station_lines_dict[st_line])[
                    -1] and c == False:
                    de[de.index(i)] = '*%&'
