...
#                     'blue_line'         : blue_line}
transit_station_lines_dict = defaultdict(list)
#Max twice
    ...
    for line1_n, line2_n in line_combination_set:
        ...
        if len(transit_stations) > 0:  #
            for transit_station in transit_stations:
                transit_station_lines_dict[line1_n].append(transit_station)
                transit_station_lines_dict[line2_n].append(transit_station)
                            ...
                            if len(possible_set[i]) ==3:
                                for x in range(len(line_name_dict[possible_set[i][0]])):
                                    for y in range(len(line_name_dict[possible_set[i][1]])):
                                        ...
                                        if line_name_dict[possible_set[i][0]][x] == line_name_dict[possible_set[i][0]][
                                            x]:
                                            ct = 1
